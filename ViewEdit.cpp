...
ViewEdit::ViewEdit(wxFrame* parent) : wxScrolledCanvas(parent, wxID_ANY)
{
    ...
    // Bind edit events to the parent frame
...
/**
 * Handle the Edit>EditMove menu event
...
/**
 * Handle the Edit>EditRotate menu event
 * @param event Command event
 */
...
/**
 * Handles updating the EditRotate
 * @param event Update UI event
 */
